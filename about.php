		...
		<div id="pageContent">
			...
			<div id="colMain"> <!-- ### MAIN CONTENT ### -->
				...
				<div id="about">
								...
								<ul>
									<li><h4>Create:</h4>
									<p>Build your own personal portfolio through the creation of individual projects, which might range from a day-long watercolor study of the human form to a 6-month collaborative venture to build a 3D representation of New York City.</p>
									</li>
									<li><h4>Share:</h4>
									<p>As you begin your new project, publish the work you create to your friends or the public for critique and inspiration. </p>
									</li>
									<li><h4>Connect:</h4>
									<p>As you begin the construction of your own portfolio, connect with other like-minded folk from around the world and create your own personal or professional network.</p>
									</li>
								</ul>
